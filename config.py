...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        # Dataset
        assert(dataset_name in ['volleyball', 'collective','interactiveBehaviordataset'])
        ...
        if dataset_name=='volleyball':
            ...
            self.data_path='/data/interactiveBehaviordataset'  #data path for the collective dataset
